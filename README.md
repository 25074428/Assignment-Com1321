...
3. ReportData Class
-The purpose of the ReportData class is to serve as a data model for products. It stores product information such as product code, name, warranty, category, price, stock level, and supplier. It also provides getter and setter methods for accessing and modifying product details.This class represents a product and stores all the information related to that product.
